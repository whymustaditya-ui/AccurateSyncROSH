...
### ⛔ Stop Supply (HOLD) (`StopSupply.gs`) + 🚦 Status Customer (`Status.gs`)
Tab **`⛔ Stop Supply (HOLD)`** (master, Nathan). `buildStopSupply` = customer dengan kode **OVD** (≥1 invoice
